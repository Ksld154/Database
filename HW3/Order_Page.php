                    ...
                    if($house_stmt->rowCount()!=0){
                        while($house_row = $house_stmt->fetch()){?>
                            <tr>
                                ...
                                <td valign="middle">
                                    <form action="Order_update.php" method="POST"><!--edit here-->
                                        <input type="hidden"name="update_order_id"value=<?php echo $house_row[0] ?>>
                                        <input type="hidden"name="house_id"value=<?php echo $house_row[7] ?>>
